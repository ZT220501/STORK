...
class FlowMatchingSTORK4Scheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def step(
        ...
        for j in range(1, mdeg + 1):
            ...
            if j == 1:
                ...
                velocity = self.velocity_approximation(self.derivative_order, diff, model_output, velocity_derivative, velocity_second_derivative, velocity_third_derivative)
