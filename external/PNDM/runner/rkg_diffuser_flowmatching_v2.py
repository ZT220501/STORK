...
class FlowMatchRKGScheduler_v2(SchedulerMixin, ConfigMixin):
    """
    ...
    def set_timesteps(
        ...
        self.timesteps = np.insert(self.timesteps, 3, self.timesteps[2] + (self.timesteps[3] - self.timesteps[2]) / 2)
        ...
        self.dt_list[2] = self.dt_list[2] * 2
        self.dt_list[3] = self.dt_list[3] * 2
    ...
    def step(
        ...
        print("self.dt_list: ", self.dt_list)

        velocity_approx_order = 0
        if self._step_index == 0 or self._step_index == 2:
            # FIRST RUN
        ...
        elif self._step_index == 1 or self._step_index == 3:
            # SECOND RUN
