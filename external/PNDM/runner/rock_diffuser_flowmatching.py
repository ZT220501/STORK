...
class FlowMatchROCKScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(
        ...
        self.dt_list = torch.tensor(self.dt_list)
    ...
    def step(
        ...
        if self._step_index == 0:
            ...
            # Restore context; here since we in fact want an approximation from initial sample to 
            # the next super-timestep, we need sample = self.initial_sample
            t = self.sigmas[0]
